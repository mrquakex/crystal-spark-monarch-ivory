...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BBkc6RQN.mjs");
...
var manifest = { "818723433dd5250f83fe230bd82594e511b8ba46423de9109b2e3faebc57c290": {
	functionName: "askGrok_createServerFn_handler",
	importer: () => import("./xai-Dq6EMkj_.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-B-owEPNH.mjs").then((n) => n.t),
